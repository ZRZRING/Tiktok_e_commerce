...
type RPCClient interface {
	...
	MarkOrderCanceled(ctx context.Context, Req *order.CancelOrderReq, callOptions ...callopt.Option) (r *common.Empty, err error)
}
...
func (c *clientImpl) MarkOrderCanceled(ctx context.Context, Req *order.CancelOrderReq, callOptions ...callopt.Option) (r *common.Empty, err error) {
